...
def transformer_iwslt_de_en(args):
    ...
    args.dec_sequence = getattr(args, 'dec_sequence', 'self_enc_mlp')
    base_architecture(args)


@register_model_architecture('transformer', 'transformer_iwslt_de_en_L10')
def transformer_iwslt_de_en_L10(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 10)
    args.decoder_layers = getattr(args, 'decoder_layers', 10)
    transformer_iwslt_de_en(args)

@register_model_architecture('transformer', 'transformer_iwslt_de_en_L12')
def transformer_iwslt_de_en_L12(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 12)
    args.decoder_layers = getattr(args, 'decoder_layers', 12)
    args.dropout = getattr(args, 'dropout', 0.4)
    transformer_iwslt_de_en_L10(args)

@register_model_architecture('transformer', 'transformer_iwslt_de_en_L16')
def transformer_iwslt_de_en_L16(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 16)
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    transformer_iwslt_de_en_L12(args)
...
@register_model_architecture('transformer', 'transformer_dbg')
def transformer_dbg(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
