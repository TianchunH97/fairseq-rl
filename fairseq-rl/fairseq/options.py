...
def add_optimization_args(parser):
    ...
    group.add_argument('--multinomial-sample-train', default=False, action='store_true',
                       help='use multinomial sampling instead of beam search for rl training sample')
    group.add_argument('--delta-reward', default=False, action='store_true',
                       help='use delta reward instead of total reward, default is total reward')
    group.add_argument('--mle-weight', default=0.0, type=float,
                       help='use mle loss combined with rl loss, weight of mle loss.')
    group.add_argument('--rl-weight', default=1.0, type=float,
                       help='use mle loss combined with rl loss, weight of rl loss.')
    group.add_argument('--max-order', default=4, type=int, 
                        help='max order for gleu')
    group.add_argument('--sample-beam', default=5, type=int, 
                        help='number of translation sentences generated by one source sentence in v2 loss')
    group.add_argument('--gram', default=0, type=int, 
                        help="if not 0, only count grams with length 'gram' in GLEU computation")
    group.add_argument('--modgleu', default=False, action='store_true', 
...
def add_generation_args(parser):
    ...
    group.add_argument('--output_path', default='',
                       help='path for the translation output')
    return group
